...
namespace Rocky.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Details(int id)
        {
            ...
            {
                Product = _prodRepo.FirstOrDefault(a=>a.Id==id, includeProperties: "Category,ApplicationType"),
                ExistsInCart = false
            };
        ...
        public IActionResult RemoveFromCart(int id)
        {
            ...
            var itemToRemove = shoppingCartList.FirstOrDefault(a=>a.ProductId == id);
